...
@section('title', 'Ajouter une Urgence')

@section('content')
<a href="{{ route('home') }}" class="btn btn-secondary mb-3">← Retour</a>

<div class="row justify-content-center">
  <div class="col-md-8">
    <div class="card">
      <div class="card-header bg-danger text-white">
        <h4 class="mb-0">🚨 Ajouter une Urgence</h4>
      </div>
      <div class="card-body">
        <form action="{{ route('urgences.store') }}" method="POST">
          ...
          <button type="submit" class="btn btn-danger w-100">Créer l'Urgence</button>
        </form>
      </div>
    </div>
  </div>
