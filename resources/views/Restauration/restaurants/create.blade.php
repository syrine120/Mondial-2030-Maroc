  ...
  <div class="col-md-8">
    <div class="card">
      <div class="card-header bg-success text-white">
        <h4 class="mb-0">➕ Créer un Restaurant</h4>
      </div>
      <div class="card-body">
        <form action="{{ route('restaurants.store') }}" method="POST">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="text" name="type_cuisine" class="form-control @error('type_cuisine') is-invalid @enderror" 
                     value="{{ old('type_cuisine') }}" placeholder="Ex: Marocain" required>
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="number" name="prix_moyen" class="form-control @error('prix_moyen') is-invalid @enderror" 
                     value="{{ old('prix_moyen') }}" step="0.01" required>
          ...
          <div class="mb-3">
            ...
            <input type="text" name="horaires" class="form-control @error('horaires') is-invalid @enderror" 
                   value="{{ old('horaires') }}" placeholder="Ex: 11h30 - 23h00">
          ...
          <button type="submit" class="btn btn-success w-100">Créer le Restaurant</button>
        </form>
      </div>
    </div>
  </div>
