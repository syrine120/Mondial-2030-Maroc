      ...
      <div class="col-md-6 col-lg-4">
        <div class="card endroit-card h-100">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              <strong><i class="bi bi-geo-alt-fill text-primary me-1"></i> Ville :</strong>
              {{ $endroit->ville->nom ?? 'Non spécifiée' }}<br>
              ...
              <strong><i class="bi bi-geo-fill text-danger me-1"></i> Adresse :</strong>
              {{ $endroit->adresse ?? 'Non spécifiée' }}<br>
              @if($endroit->horaires)
