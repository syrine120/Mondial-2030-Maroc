  ...
  <div class="col-md-8">
    <div class="card">
      <div class="card-header bg-success text-white">
        <h4 class="mb-0">➕ Créer un Airbnb</h4>
      </div>
      <div class="card-body">
        <form action="{{ route('airbnbs.store') }}" method="POST">
          @csrf
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="number" name="prix_nuit" class="form-control @error('prix_nuit') is-invalid @enderror" 
                     value="{{ old('prix_nuit') }}" step="0.01" required>
          ...
          <button type="submit" class="btn btn-success w-100">Créer l'Airbnb</button>
        </form>
      </div>
    </div>
  </div>
