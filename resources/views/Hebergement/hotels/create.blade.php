    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h4 class="mb-0">➕ Ajouter un Hôtel</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('hotels.store') }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary w-100">Ajouter l'hôtel</button>
                </form>
            </div>
        </div>
    </div>
