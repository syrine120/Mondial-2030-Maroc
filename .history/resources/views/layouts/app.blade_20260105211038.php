...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    } else if (currentPath === '/carte') {
      // Page Carte : 1 SEUL bouton "Retour au guide"
      buttonsHTML = `
        <a href="{{ route('home') }}" class="btn btn-outline-info btn-return">
          <i class="bi bi-house me-2"></i> Retour au guide
        </a>
      `;
      returnButtonsDiv.innerHTML = buttonsHTML;
      returnButtonsDiv.classList.add('show');
    } else {
      // Pages Ressources (villes, hôtels, etc.) : 3 BOUTONS
      buttonsHTML = `
        ...
        <a href="{{ route('carte') }}" class="btn btn-outline-primary btn-return">
