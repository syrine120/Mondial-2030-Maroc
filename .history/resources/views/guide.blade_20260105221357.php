  ...
  <div class="row">
    <div class="col-lg-8 mx-auto">
      ...
      <div class="text-center" style="margin-top: 50px;">
        ...
        <a href="{{ route('home') }}" class="btn btn-lg" style="background: linear-gradient(45deg, #c1272d, #006233); color: white; border: none; padding: 20px 40px; font-size: 1.4rem; font-weight: bold; border-radius: 50px; box-shadow: 0 8px 25px rgba(193, 39, 45, 0.3); text-decoration: none; transition: all 0.3s ease;">
          🚀 LANCER L'AVENTURE !
        </a>
